...
(function () {
    ...
    function cargarResumen(estado, ui) {
        ...
        fetch(
            '/ascc/backend/users/api/reviews.php?action=summary' +
    ...
    function cargarResenas(estado, ui, esInicial) {
        ...
        fetch(
            '/ascc/backend/users/api/reviews.php?action=list' +
            '&tipo=' + encodeURIComponent(estado.tipo) +
            '&id='   + estado.id +
            '&page=' + estado.pagina,
            { headers: { 'X-Requested-With': 'XMLHttpRequest' } }
    ...
    function renderResenas(resenas, contenedor, reemplazar) {
        ...
        resenas.forEach(function (r) {
            ...
            var avatarHtml = r.autor_foto
                ? '<img src="/ascc/frontend/users/public/' + esc(r.autor_foto) + '"' +
    ...
    function enviarResena(estado, ui) {
        ...
        fetch('/ascc/backend/users/api/reviews.php', {
            method:  'POST',
            headers: { 'X-Requested-With': 'XMLHttpRequest' },
            body:    form,
        })
