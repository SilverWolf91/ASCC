...
function marcarVendido(id) {
    if (confirm('¿Marcar este producto como vendido?')) {
        window.location.href = '/ascc/backend/users/controllers/ProductoController.php?accion=marcar_vendido&id=' + id;
    }
}

function eliminarProducto(id) {
    if (confirm('¿Estas seguro de eliminar este producto?\n\nEsta accion no se puede deshacer.')) {
        window.location.href = '/ascc/backend/users/controllers/ProductoController.php?accion=eliminar&id=' + id;
    }
}
...
function loadMessages(id) {
    ...
    fetch('/ascc/backend/users/controllers/MensajesController.php?accion=obtener_mensajes&id_conversacion=' + id)
        .then(function(r) { return r.json(); })
        .then(function(data) { 
...
function sendMessage() {
    ...
    fetch('/ascc/backend/users/controllers/MensajesController.php', { method: 'POST', body: formData })
        .then(function(r) { return r.json(); })
        .then(function(data) {
...
function uploadPhoto() {
    ...
    fetch('/ascc/backend/users/controllers/PerfilController.php', { method: 'POST', body: formData })
...
async function cargarNotificaciones() {
    try {
        var res  = await fetch('/ascc/backend/users/api/get_notificaciones.php', { method: 'GET' });
...
async function marcarLeida(id) {
    try {
        ...
        await fetch('/ascc/backend/users/api/get_notificaciones.php', { method: 'POST', body: fd });
