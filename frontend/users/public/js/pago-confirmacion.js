...
function mostrarPagoAprobado() {
    ...
    // const audio = new Audio('/ascc/frontend/users/public/sounds/success.mp3');
    // audio.play();
}
...
function verificarEstadoPago() {
    fetch(`/ascc/backend/users/api/verificar_estado_pago.php?ref=${encodeURIComponent(referencia)}`)
