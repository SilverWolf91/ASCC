...
(function () {
    ...
    async function solicitarOtp(btn, tipo, emailNuevo, wrapper, timerEl, timerKey) {
        ...
        try {
            ...
            const res  = await fetch('/ascc/backend/users/api/solicitar_otp.php', { method: 'POST', body: fd });
    ...
    btnGuardar?.addEventListener('click', async function () {
        ...
        try {
            ...
            const response = await fetch('/ascc/backend/users/controllers/update_profile.php', {
                method: 'POST',
                body: formData,
            });
