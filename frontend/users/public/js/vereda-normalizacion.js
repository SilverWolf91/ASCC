...
(function(window) {
    ...
    function buscarVeredaSimilar(veredaEscrita, municipio, callback) {
        ...
        var url = '/ascc/backend/users/controllers/UbicacionController.php?accion=buscar_similar&vereda=' + 
    ...
    function inicializarAutocompletadoVeredas(inputId, municipioInputId) {
        ...
        input.addEventListener('input', function() {
            ...
            timeoutId = setTimeout(function() {
                var xhr = new XMLHttpRequest();
                var url = '/ascc/backend/users/controllers/UbicacionController.php?accion=autocompletar_vereda&query=' + 
