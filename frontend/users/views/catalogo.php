...
<head>
    ...
    <link rel="icon" href="/ascc/frontend/users/public/img/logo.png">
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/ascc-theme.css">
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/<?= $theme ?>.css">
...
<body class="theme-<?= $theme ?>">
    ...
    <div class="catalogo-container">
        <aside class="filtros-sidebar">
            ...
            <form method="GET" action="/ascc/frontend/users/views/catalogo.php" id="formFiltros">
                <?php if ($en_iframe): ?>
                ...
                <div class="filtros-footer">
                    ...
                    <a href="/ascc/frontend/users/views/catalogo.php<?= $en_iframe ? '?embed=1' : '' ?>" class="btn-limpiar">
                        🗑️ <?= t('clear_filters') ?>
                    </a>
                </div>
            </form>
            ...
            <div id="listView">
                ...
                <div class="productos-grid">
                    <?php foreach ($productos as $prod):
                        ...
                        $perfil_url = '/ascc/frontend/users/views/perfil_vendedor.php?id=' . $prod['id_usuario'];
                        $es_mi_producto = $visitante_logueado && $visitante_id === (int)$prod['id_usuario'];
                    ?>
                    <article class="producto-card"
                        onclick="window.location.href='/ascc/frontend/users/views/producto_detalle.php?id=<?= $prod['id_producto'] ?>'">
                        ...
                        <img src="/ascc/frontend/users/public/<?= $prod['ruta_imagen'] ?? 'img/no-image.png' ?>"
    ...
    <script src="/ascc/frontend/users/public/js/colombia_locations.js"></script>
    ...
    selectDepartamento.addEventListener('change', async function() {
        ...
        try {
            const r = await fetch(
                `/ascc/backend/users/api/get_municipios.php?departamento=${encodeURIComponent(departamento)}`);
    ...
    selectMunicipio.addEventListener('change', async function() {
        ...
        try {
            const r = await fetch(
                `/ascc/backend/users/api/get_veredas.php?departamento=${encodeURIComponent(departamento)}&municipio=${encodeURIComponent(municipio)}`
                );
                ...
                if (!isNaN(lat) && !isNaN(lng)) {
                    ...
                    const info = new google.maps.InfoWindow({
                        content: `<div style="padding:10px;max-width:250px">
                            ...
                            <a href="/ascc/frontend/users/views/producto_detalle.php?id=${p.id_producto}"
