...
<head>
    ...
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/verificar-registro.css">
</head>
<body>
    ...
    <div class="verify-card">
        ...
        <div class="vc-body">
            ...
            <form id="formVerificar" action="/ascc/backend/users/controllers/verificar_token_registro.php" method="POST">
            ...
            <!-- Volver al registro -->
            <a href="/ascc/frontend/users/views/auth/registro.php" class="back-link">
    ...
    <script src="/ascc/frontend/users/public/js/verificar-registro.js"></script>
