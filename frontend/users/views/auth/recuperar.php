...
<head>
    ...
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/recuperar.css">
</head>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <main class="recovery-container">
            ...
            <!-- Formulario -->
            <form action="/ascc/backend/users/controllers/RecuperarController.php" method="POST">
            ...
            <div class="login-link">
                ¿Recordaste tu contraseña? <a href="/ascc/frontend/users/views/auth/login.php">Inicia sesión aquí</a>
            </div>
