...
if (!isset($_SESSION['id_usuario'])) {
    header('Location: /ascc/frontend/users/views/auth/login.php?redirect=reportes');
    exit;
}
...
$api_url   = $api_token
    ? "http://localhost/ascc/backend/users/api/reportes_data.php?token={$api_token}"
    : '';
...
<head>
    ...
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/reportes.css?v=<?= time() ?>">
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>">
    ...
    <div class="rep-container">
        ...
        <div class="rep-header">
            <div class="rep-header__info">
                <a href="/ascc/frontend/users/views/dashboard.php" class="rep-back-link">
                    <?= t('dashboard') ?>
                </a>
    ...
    <!-- Scripts -->
    <script src="/ascc/frontend/users/public/js/reportes.js?v=<?= time() ?>"></script>
