...
<head>
    ...
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/procesar-pago.css">
...
<body data-wompi-public-key="<?= htmlspecialchars($WOMPI_PUBLIC_KEY) ?>"
    ...
    <div class="payment-container">
        <a href="/ascc/frontend/users/views/producto_detalle.php?id=<?= $id_producto ?>" class="back-link">← Volver al producto</a>
    ...
    <script src="/ascc/frontend/users/public/js/procesar-pago.js"></script>
</body>
