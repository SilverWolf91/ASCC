...
<head>
    ...
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/modal-perfil.css">
</head>
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>">
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar collapsed">
            ...
            <div class="sidebar-header">
                <div class="logo">
                    <img src="/ascc/frontend/users/public/img/logo.png" alt="<?= t('app_name') ?>">
                    <span>A S C C</span>
                </div>
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a class="nav-item" href="/ascc/frontend/users/views/reportes.php" target="_self">
                        <span class="nav-icon">📈</span>
            ...
            <div class="sidebar-footer">
                <div class="user-profile">
                    ...
                    <img src="/ascc/frontend/users/public/<?= htmlspecialchars($usuario['foto_perfil']) ?>"
                ...
                <a href="/ascc/backend/users/controllers/logout.php" class="btn-logout">
                    <?= t('logout') ?>
                </a>
            </div>
        ...
        <main class="main-content">
            ...
            <div class="container">
                ...
                <div id="inicio" class="tab-content active">
                    <div class="inicio-grid">
                        ...
                        <div class="profile-card">
                            ...
                            <a href="/ascc/frontend/users/views/reportes.php" class="btn-update-profile"
                ...
                <div id="misProductos" class="tab-content">
                    ...
                    <div class="products-grid">
                        ...
                        <div class="product-card">
                            <img src="/ascc/frontend/users/public/<?= $thumb ?>"
                ...
                <div id="mensajes" class="tab-content">
                    <iframe src="/ascc/frontend/users/views/mensajes.php" style="width:100%; height:100vh; border:none;"></iframe>
                </div>

                <!-- ── TAB: PUBLICAR — solo vendedor y mixto ──────── -->
                <?php if ($puede_vender): ?>
                <div id="publicar" class="tab-content">
                    <iframe src="/ascc/frontend/users/views/crear_producto.php?embed=1"
                ...
                <div id="catalogo" class="tab-content">
                    <iframe src="/ascc/frontend/users/views/catalogo.php?embed=1" style="width:100%; height:100vh; border:none;"></iframe>
                </div>
                <?php endif; ?>
            ...
            <div class="photo-modal-body">
                <div class="photo-preview-container">
                    <div class="photo-preview" id="photoPreview">
                        <?php if (!empty($usuario['foto_perfil'])): ?>
                        <img src="/ascc/frontend/users/public/<?= htmlspecialchars($usuario['foto_perfil']) ?>" alt="Preview"
                            id="previewImage">
                        <?php else: ?>
    ...
    <script src="/ascc/frontend/users/public/js/sync-global.js" defer></script>
    <script src="/ascc/frontend/users/public/js/dashboard-sync.js" defer></script>
    <script src="/ascc/frontend/users/public/js/dashboard.js" defer></script>
    <script src="/ascc/frontend/users/public/js/modal-perfil.js" defer></script>
