...
<head>
    ...
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/crear-producto.css">
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>">
    ...
    <div class="form-container">
        ...
        <form action="/ascc/backend/users/controllers/ProductoController.php" method="POST" enctype="multipart/form-data"
            id="productForm">
    ...
    <script src="/ascc/frontend/users/public/js/crear-producto.js"></script>
