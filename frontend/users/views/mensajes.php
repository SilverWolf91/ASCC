...
<head>
    ...
    <!-- CSS según tema -->
    <?= ascc_theme_css() ?>
    <link rel="stylesheet" href="/ascc/frontend/users/public/css/mensajes.css">
</head>
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>">
        ...
        <aside class="conversaciones-sidebar">
            ...
            <div class="conversaciones-list">
                ...
                <div class="conversation-item <?= $class_unread ?>"
                    ...
                    <img src="/ascc/frontend/users/public/<?= htmlspecialchars($conv['foto_otro_usuario']) ?>"
    ...
    <script src="/ascc/frontend/users/public/js/mensajes.js"></script>
