...
if (!isset($_SESSION['id_usuario'])) {
    header('Location: /ascc/frontend/users/views/auth/login.php?redirect=visitas_detalle');
    exit;
}
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>">
    ...
    <div class="vis-container">
        ...
        <div class="vis-header">
            <a href="/ascc/frontend/users/views/reportes.php#visitas" class="vis-back">
                <?= t('vis_back_reportes') ?>
            </a>
                            ...
                            <div class="vis-frecuente-info">
                                <div class="vis-frecuente-nombre">
                                    <?php if (in_array($f['rol'], ['comprador', 'mixto'], true)): ?>
                                        <a href="/ascc/frontend/users/views/perfil_comprador.php?id=<?= $f['id_usuario'] ?>" class="vis-link">
                                            <?= htmlspecialchars($f['nombre']) ?>
                                        </a>
                                    <?php else: ?>
                                        <a href="/ascc/frontend/users/views/perfil_vendedor.php?id=<?= $f['id_usuario'] ?>" class="vis-link">
                                            <?= htmlspecialchars($f['nombre']) ?>
                                        </a>
                                    <?php endif; ?>
                                </div>
                                                ...
                                                <div>
                                                    <?php if ($es_logueado): ?>
                                                        <?php if (in_array($v['rol'], ['comprador', 'mixto'], true)): ?>
                                                            <a href="/ascc/frontend/users/views/perfil_comprador.php?id=<?= $v['id_usuario'] ?>"
                                                                class="vis-link">
                                                                <?= $nombre_vis ?>
                                                            </a>
                                                        <?php else: ?>
                                                            <a href="/ascc/frontend/users/views/perfil_vendedor.php?id=<?= $v['id_usuario'] ?>"
                                                                class="vis-link">
                                                                <?= $nombre_vis ?>
                                                            </a>
                                                        <?php endif; ?>
