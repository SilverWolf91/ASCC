...
RepAdmin.apiUrl = RepAdmin.config.apiUrl || '/ascc/backend/admin/ajax/reportes_admin.php';
...
RepAdmin.initExportar = function () {
    ...
    if (btnExcel) {
        btnExcel.addEventListener('click', () => {
            ...
            window.location.href = `/ascc/backend/admin/ajax/reportes_admin.php?action=excel_admin&secciones=${secs}&csrf=${RepAdmin.csrf}`;
        });
    }
    ...
    if (btnCsv) {
        btnCsv.addEventListener('click', () => {
            const secs = RepAdmin.getSeccionesSeleccionadas();
            window.location.href = `/ascc/backend/admin/ajax/reportes_admin.php?action=csv_admin&secciones=${secs}&csrf=${RepAdmin.csrf}`;
        });
    }
};
