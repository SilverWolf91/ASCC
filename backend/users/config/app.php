...
$_lang_file = __DIR__ . '/../../../frontend/users/lang/' . $lang . '.php';

$translations = file_exists($_lang_file)
    ? require $_lang_file
    : require __DIR__ . '/../../../frontend/users/lang/es.php';
...
function ascc_theme_css(): string
{
    ...
    $filepath = $_SERVER['DOCUMENT_ROOT'] . '/ascc/frontend/users/public/css/' . $file;
    $version  = file_exists($filepath) ? filemtime($filepath) : '1';

    return '<link rel="stylesheet" id="ascc-theme-css"'
        . ' href="/ascc/frontend/users/public/css/' . $file . '?v=' . $version . '">';
}
