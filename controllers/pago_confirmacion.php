...
<body>
    <div class="header">
        <div class="logo" style="display: flex; align-items: center; gap: 12px;">
            <img src="/ascc/public/img/logo.png" alt="ASCC Logo" style="height: 45px;">
    ...
    <div class="confirmation-container">
        <div class="confirmation-card">
            ...
            <div class="action-buttons">
                <a href="/ascc/catalogo.php" class="btn btn-secondary">🛒 Ver más productos</a>
                <a href="/ascc/dashboard.php" class="btn btn-primary">📊 Ir al Dashboard</a>
            </div>
            <?php elseif ($estado_pago === 'REJECTED'): ?>
            <div class="action-buttons">
                <a href="/ascc/producto_detalle.php?id=<?= $id_producto ?>" class="btn btn-secondary">🔄 Intentar de
                    nuevo</a>
                <a href="/ascc/catalogo.php" class="btn btn-primary">🛒 Ver otros productos</a>
            </div>
            <?php endif; ?>
