...
<head>
    ...
    <link rel="stylesheet"
        href="/ascc/public/css/producto-detalle.css?v=<?= filemtime(__DIR__ . '/public/css/producto-detalle.css') ?>">
    <link rel="stylesheet"
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>">
    ...
    <div class="detail-container">
        ...
        <a href="/ascc/catalogo.php" class="back-link">
            ← <?= t('back_to_catalog') ?>
        </a>
        ...
        <div class="vendor-card">
            <div class="vendor-info">
                ...
                <div class="vendor-avatar">
                    ...
                    <img src="<?= htmlspecialchars(getImageUrl($vendedor['foto_perfil'])) ?>"
        ...
        <div class="vendor-card" style="margin-top:1.5rem">
            ...
            <div style="
                ...
                <a href="/ascc/producto_detalle.php?id=<?= $prod['id_producto'] ?>&origen=perfil" style="
                            display:block;
                    ...
                    <img src="<?= htmlspecialchars(getImageUrl($prod['imagen'])) ?>"
                        ...
                        onerror="this.src='/ascc/public/img/no-image.png'" loading="lazy">
