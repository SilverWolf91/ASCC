...
<head>
    ...
    <link rel="stylesheet" href="/ascc/public/css/registro.css">
</head>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <main class="register-container">
            ...
            <div class="login-link">
                ¿Ya tienes cuenta? <a href="/ascc/views/auth/login.php">Inicia sesión aquí</a>
            </div>
    ...
    <script src="/ascc/public/js/registro.js"></script>
