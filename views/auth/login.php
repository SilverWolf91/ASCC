...
<head>
    ...
    <link rel="stylesheet" href="/ascc/public/css/login.css">
</head>
...
<body>
        ...
        <main class="login-container">
            ...
            <div class="logo-section">
                <div class="logo-wrapper">
                    <img src="/ascc/public/img/logo.png" alt="Aromas y Sabores de mi Campo Colombiano (ASCC) Logo">
                </div>
                <h1>
            ...
            <!-- Formulario -->
            <form action="/ascc/controllers/AuthController.php" method="POST">
            ...
            <div class="forgot-password">
                <a href="/ascc/views/auth/recuperar.php">¿Olvidaste tu contraseña? 🔑</a>
            </div>

            <div class="divider">ó</div>

            <div class="register-link">
                ¿No tienes cuenta? <a href="/ascc/views/auth/registro.php">Regístrate aquí</a>
            </div>
    ...
    <script src="/ascc/public/js/login.js"></script>
