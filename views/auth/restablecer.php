...
<head>
    ...
    <link rel="stylesheet" href="/ascc/public/css/restablecer.css">
</head>
...
<body>
    ...
    <div class="reset-container">
        ...
        <div class="error-container">
            ...
            <a href="/ascc/views/auth/recuperar.php" class="btn-link">
        ...
        <form action="/ascc/controllers/RecuperarController.php" method="POST" onsubmit="return validateForm()">
    ...
    <script src="/ascc/public/js/restablecer.js"></script>
