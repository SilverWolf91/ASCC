...
<head>
    ...
    <link rel="stylesheet" href="/ascc/public/css/producto-detalle.css?v=<?= time() ?>">

    <!-- CSS Módulo de Reseñas -->
    <link rel="stylesheet"
        href="/ascc/public/css/reviews.css?v=<?= filemtime(__DIR__ . '/public/css/reviews.css') ?>">
...
<body class="theme-<?= $theme ?>" data-theme="<?= $theme ?>" data-precio-unitario="<?= $producto['precio'] ?>"
    ...
    <div class="detail-container">
        ...
        <a href="/ascc/catalogo.php" class="back-link">← <?= t('back_to_catalog') ?></a>
        ...
        <div class="product-detail">
            ...
            <div class="image-gallery">
                <div class="carousel-container" id="carouselContainer">
                    ...
                    <img src="<?= htmlspecialchars(getImageUrl($img['ruta_imagen'])) ?>"
                    ...
                    <?php endif; ?>
                    <?php else: ?>
                    <img src="/ascc/public/img/no-image.png" alt="Sin imagen" class="carousel-image active">
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="vendor-card">
            ...
            <a href="/ascc/perfil_vendedor.php?id=<?= $producto['vendedor_id'] ?>" class="btn-ver-perfil-vendedor">
    ...
    <script src="/ascc/public/js/producto-detalle.js?v=<?= time() ?>"></script>
    <script src="/ascc/public/js/reviews.js?v=<?= filemtime(__DIR__ . '/public/js/reviews.js') ?>"></script>
