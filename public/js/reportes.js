...
Rep.cargarGraficaVentas = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=ventas_diarias&csrf='
...
Rep.cargarGraficaProductos = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=productos_ventas&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaCategorias = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=categorias_ventas&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaPrecio = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=precio_scatter&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaFunnel = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=funnel&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaComprasCat = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=compras_categorias&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaGasto = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=gasto_mensual&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaVisitasPerfil = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=visitas_perfil&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.cargarGraficaEvolucion = function () {
    ...
    fetch('/ascc/api/reportes_data.php?action=evolucion_calificacion&csrf='
        + encodeURIComponent(window.REP_CONFIG?.csrf_token || ''))
        .then(r => r.json())
        .then(data => {
            if (!data.success) return;
...
Rep.enviarDenuncia = function (cerrarCb) {
    ...
    fetch('/ascc/api/reportes_data.php', {
        method: 'POST',
        body:   formData,
    })
    .then(r => r.json())
...
Rep.initExportBtns = function () {
    ...
    if (btnExcel) {
        btnExcel.addEventListener('click', () => {
            ...
            window.location.href = `/ascc/api/reportes_data.php?action=excel&secciones=${secs}&csrf=${csrf}`;
        });
    }
    ...
    if (btnCsv) {
        btnCsv.addEventListener('click', () => {
            const secs = getSeccionesSeleccionadas();
            const csrf = window.REP_CONFIG?.csrf_token || '';
            window.location.href = `/ascc/api/reportes_data.php?action=csv&secciones=${secs}&csrf=${csrf}`;
        });
    }
};
...
Rep.initGenerarToken = function () {
    ...
    btn.addEventListener('click', () => {
        ...
        fetch('/ascc/api/reportes_data.php', { method: 'POST', body: formData })
            .then(r => r.json())
            .then(data => {
