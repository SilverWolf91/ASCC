...
function loadMessages(conversationId) {
    ...
    fetch(`/ascc/controllers/MensajesController.php?accion=obtener_mensajes&id_conversacion=${conversationId}`)
...
function sendMessage() {
    ...
    fetch('/ascc/controllers/MensajesController.php', {
        method: 'POST',
        headers: {
...
function openProductModal() {
    ...
    fetch(`/ascc/controllers/ProductoController.php?accion=obtener_producto&id_conversacion=${conversacionActiva}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function verificarMensajesNuevos() {
    ...
    fetch(`/ascc/controllers/MensajesController.php?accion=obtener_mensajes_nuevos&id_conversacion=${conversacionActiva}&ultimo_id=${ultimoMensajeId}`)
        .then(response => {
...
function reproducirSonidoNotificacion() {
    ...
    try {
        const audio = new Audio('/ascc/public/sounds/notification.mp3');
        ...
        audio.addEventListener('error', (e) => {
            ...
            console.error('[AUDIO] Verificar que exista: /ascc/public/sounds/notification.mp3');
        });
