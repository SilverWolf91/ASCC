        ...
        <div class="pc-hero-card">
            ...
            <div class="pc-avatar-wrap">
                <?php if ($comprador['foto_perfil']): ?>
                    <img src="<?= htmlspecialchars(getImageUrl($comprador['foto_perfil'])) ?>"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="pc-prod-cell">
                                                <img src="<?= htmlspecialchars(getImageUrl($h['imagen'])) ?>"
                        ...
                        <div class="pc-resena-item">
                            <div class="pc-resena-header">
                                ...
                                <div class="pc-resena-meta">
                                    <?= t('vendor') ?>:
                                    <a href="/ascc/perfil_vendedor.php?id=<?= $res['id_vendedor'] ?>" class="vis-link">
